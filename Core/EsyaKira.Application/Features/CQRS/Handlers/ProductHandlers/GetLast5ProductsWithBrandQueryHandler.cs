...
{
    public class GetLast5ProductsWithBrandQueryHandler
    {
        private readonly IProductRepository _repository;

        public GetLast5ProductsWithBrandQueryHandler(IProductRepository repository)
        {
        ...
        {
            var values = _repository.GetLast5ProductsListWithBrands();
