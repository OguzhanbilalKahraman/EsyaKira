using EsyaKira.Application.Features.CQRS.Commands.AboutCommands;
using EsyaKira.Application.Features.CQRS.Handlers.AboutHandlers;
using EsyaKira.Application.Features.CQRS.Queries.AboutQueries;
...
namespace EsyaKira.WebApi.Controllers
{
    ...
    public class AboutsController : ControllerBase
    {
        ...
        public AboutsController(CreateAboutCommandHandler createCommandHandler, GetAboutByIdQueryHandler getAboutByIdQueryHandler, GetAboutQueryHandler getAboutQueryHandler, UpdateAboutCommandHandler updateCommandHandler, RemoveAboutCommandHandler removeCommandHandler)
        {
